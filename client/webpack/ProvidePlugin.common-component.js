...
module.exports = {
  ...
  SearchAddButtonProps: [
    path.resolve(__dirname, '../src/component/@Common/Buttons/SearchAddButton/index.ts'),
    'SearchAddButtonProps',
  ],
  SearchExportButton: [
  ...
  HashSearchTableProps: [
    path.resolve(__dirname, '../src/component/@Common/HashSearchTable/index.ts'),
    'HashSearchTableProps',
  ],
